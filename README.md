...
| Date | Topic |
| ---- | ----- |
| **Week 1**  | [Course syllabus][syllabus] [[PDF][syllabus]] <br> Recommended textbook: ["Artificial Intelligence: A Modern Approach, 3rd Edition"][ebook], ["4th Editon"] <br>Lecture 0: [Introduction to Artificial Intelligence][00] Readings [[AIMA Chapter 1][chapter]] <br> Optional Reading: [Turing's Paper][paper]  |
