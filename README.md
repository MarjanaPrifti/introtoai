...
| Date | Topic |
| ---- | ----- |
| **Week 1** - February 21,2024 | [Course syllabus][syllabus] [[PDF][syllabus]] <br> Recommended textbook: ["Artificial Intelligence: A Modern Approach, 3rd Edition"][ebook] <br>Lecture 0: [Introduction to artificial intelligence][] [[Chapter 1][chapter]] <br> Lecture 1: [Intelligent agents][] [[PDF][]]  |
